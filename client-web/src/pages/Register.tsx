...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await authApi.register(formData.email, formData.password, formData.username);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 py-12">
      ...
      <div className="relative z-10 bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 px-8 py-10 text-white">
          ...
          <p className="text-center text-purple-100 mt-2">Join AREA and automate your workflow</p>
        </div>
